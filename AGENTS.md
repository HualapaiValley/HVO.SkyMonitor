...
- `LogicHost` is the central ASP.NET host; it owns SQL Server/Redis/provider-neutral S3-backed central services and runs EF migrations plus seed data at startup.
