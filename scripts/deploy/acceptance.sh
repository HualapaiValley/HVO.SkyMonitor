...
deploy_acceptance_required_ids() {
    jq -cn '[
      ...
      "logichost-network-outage","object-store-failure","sql-failure","worker-before-output-crash",
      ...
      "raw-boundary-before-identity-reservation","raw-boundary-after-identity-reservation","raw-boundary-before-initialization-lifecycle-lock",
      ...
      "calibration-before-manifest-write","calibration-manifest-publication","calibration-before-bundle-write","calibration-bundle-publication",
      "calibration-before-profile-write","calibration-profile-publication","calibration-directory-sync","calibration-sqlite-publication","calibration-activation-commit",
