...
exporter) and the follow-up #564 (audited observer-coordinate mutation) are
claimed; #534 waits on #537 and #535 on #534 for release convergence, and #563
remains a recorded follow-up. One coordinator owns both queues and the shared
