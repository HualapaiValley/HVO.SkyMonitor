...
#517, #507, #516, #536, #533, #564, #537, and #563 are delivered. #534
(independent image and offline bundle) is in review on draft PR #595; its agreed
deferrals #597 (component-level image SBOM and registry attestation) and #598
(signed image upgrade and rollback in the installer campaign) are scheduled
ahead of #535, which closes the initiative. One coordinator owns both queues and the shared
