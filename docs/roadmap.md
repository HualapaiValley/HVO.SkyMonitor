...
failing the arm64 publish smoke; PR #616) are delivered. #608 (a runtime
regression from #519: live executions froze the rolling-combination window at
acceptance, so combined frames collapsed to one source; in review on PR #615),
#598 (signed upgrade and rollback in the installer campaign), #597
(component-level image SBOM and registry attestation), and #599 (signed release
in the standalone preflight) remain, with hygiene follow-ups #617, #618, #619,
and #621 tracked beside them. #535 closes the initiative after them. One coordinator owns both queues and the shared
