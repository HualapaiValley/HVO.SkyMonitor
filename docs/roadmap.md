...
`RM-017` is Current beside the partially paused `RM-005`; #532 is delivered and
#515 is the active critical-path candidate. One coordinator owns both queues and
the shared two-issue global capacity.
