...
and #517 are delivered, #507 is in progress (PR #561), #516 is the claimed
final implementation child over the delivered shell, archive, and workspace,
and #536 is unblocked by #428 as the next candidate when capacity frees. #533
stays deferred behind the shared Docker window. One coordinator owns both
queues and the shared two-issue global capacity.
