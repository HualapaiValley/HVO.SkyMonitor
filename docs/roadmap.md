...
#517, #507, #516, #536, #533, #564, and #537 are delivered. #534 (independent
image and offline bundle) is claimed now that every prerequisite is merged, and
the follow-up #563 (durable automation definitions) is in progress; #535 closes
the initiative after #534. One coordinator owns both queues and the shared
