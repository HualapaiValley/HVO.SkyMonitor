...
#517, #507, and #516 are delivered, completing the operator surface tranche.
#536 (shared export contract) and #533 (component-scoped gates) are claimed;
#537, #534, and #535 follow them on the release convergence path, and #563 and
#564 are recorded follow-ups. One coordinator owns both queues and the shared
