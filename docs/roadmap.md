...
#517, #507, #516, #536, #533, and #564 are delivered. #537 (durable evidence
exporter) and the follow-up #563 (durable automation definitions) are claimed;
#534 waits on #537 and #535 on #534 for release convergence. One coordinator
owns both queues and the shared two-issue global capacity.
