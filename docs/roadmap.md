...
collapsed to one source; PR #615) are delivered. #599 (signed release in the
standalone preflight; PR #623 in protected CI), #598 (signed upgrade and
rollback in the installer campaign; claimed), and #597 (component-level image
SBOM and registry attestation) remain, with hygiene follow-ups #617, #618,
#619, #620, and #621 tracked beside them. #535 closes the initiative after
them. One coordinator owns both queues and the shared
