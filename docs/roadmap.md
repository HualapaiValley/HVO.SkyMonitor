...
production smoke's 5.5 s arrival budget on the shared host, which blocks
final-mode citable evidence), #651 (arm64 end-to-end qualification: signed
install, upgrade, rollback, and container smoke on aarch64), and #645
(installed evidence omits the inventory asset). Hygiene follow-ups tracked
beside them: #582, #596, #609, #610, #611, #618, #619, #620, #621, #625, #626,
#627, #628, #629, #630, #638, #642, #649, and #650. #535 closes the initiative
after them. One coordinator owns both queues and the shared
