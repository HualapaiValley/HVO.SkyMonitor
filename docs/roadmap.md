...
#517, #507, #516, and #536 are delivered. #533 (component-scoped gates) and
#537 (durable evidence exporter) are claimed; #534 and #535 follow them on the
release convergence path, and #563 and #564 are recorded follow-ups. One
coordinator owns both queues and the shared two-issue global capacity.
