...
#517, and #507 are delivered, #516 is the claimed final implementation child
over the delivered shell, archive, and workspace, and #536 is claimed as the
shared export-contract half unblocked by #428. #533 stays deferred behind the
shared Docker window. One coordinator owns both queues and the shared
