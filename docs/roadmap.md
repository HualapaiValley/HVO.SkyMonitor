...
`RM-017` is Current beside the partially paused `RM-005`; #532 and #515 are
delivered, and the shell foundation unblocks #514 and #517, then #516, as the
next critical-path candidates. One coordinator owns both queues and the shared
