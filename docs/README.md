...
| Split-host deployment through controlled startup | `docs/runbooks/split-host-preflight.md` | Versioned inventory, remote preparation, immutable images, verified catalogs, optional scoped services, controlled database initialization, gated agents, resumable ledgers, and sanitized evidence. |
