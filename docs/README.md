...
| Split-host deployment preflight | `docs/runbooks/split-host-preflight.md` | Versioned inventory, explicit SSH/Docker routing, read-only multi-host checks, resumable manifest, and sanitized evidence. |
