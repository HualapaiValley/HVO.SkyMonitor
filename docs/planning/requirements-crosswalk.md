...
| `OPS-001`-`OPS-010` | Fixture/full catalog distinction, product/component/UUID instance roots, named catalog selection, persistent CameraAgent state, SQL/Redis/MinIO/Mailpit ownership, names/prefixes/buckets, safe migration/reset, backup/restore, and reconciliation | `docs/project-plan.md`; `docs/runbooks/*.md` | #111, #114, #120, #243, #108, #414 |
