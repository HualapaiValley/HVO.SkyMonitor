...
| `S3-001`-`S3-002` | Retained provider-specific S3 adapter behavior and independently qualified external S3/LAN or AWS profile | `docs/project-plan.md` section 3.12; object-storage decision | Delivered boundary #504; `RM-019` #588, #589; SeaweedFS 4.44 no-go #505 |
