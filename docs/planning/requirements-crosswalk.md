...
| `OPS-001`-`OPS-004` | Fixture/full catalog distinction, persistent CameraAgent state, product/component/UUID instance and named catalog roots, and self-contained local installation from immutable offline inputs with resumable redacted evidence | `docs/project-plan.md`; `docs/runbooks/*.md`; `docs/runbooks/deployment-installer.md` | #111, #114, #120, #243, #108, #414, #415 |
