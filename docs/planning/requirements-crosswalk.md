...
| IDs | Requirement group | Owning source | Phase/issues |
| --- | --- | --- | --- |
| `S3-001` | Provider-neutral LogicHost S3 boundary, normalized semantics, configuration, authenticated health, integrity, conformance, and infrastructure ownership | `docs/project-plan.md` section 3.12 | `RM-016`; #499, #504 |
| `S3-002` | Immutable local-backend qualification covering API behavior, security, supply chain, recovery, faults, observability, performance, and native amd64/arm64 | `docs/project-plan.md` section 3.12 | `RM-016`; #499, #505 |
| `S3-003` | Fresh-state supported adoption, least-privilege provisioning, deployment/test/CI replacement, operational lifecycle, and removal of current MinIO ownership | `docs/project-plan.md` section 3.12 | `RM-016`; #499, #506 |
