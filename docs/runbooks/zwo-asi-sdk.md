...
The same Dockerfile is verified on native Linux x64 and Raspberry Pi ARM64. The
2026-08-03 ARM64 acceptance built from merged source with the pinned .NET
