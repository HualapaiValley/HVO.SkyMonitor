...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=3480`, `Integration=670`, `Manual=103`, `Soak=1`, `External=0`, and `Hardware=1`.
