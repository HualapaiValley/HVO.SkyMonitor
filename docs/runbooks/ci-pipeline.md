...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=2776`, `Integration=615`, `Manual=93`, `Soak=1`, `External=0`, and `Hardware=1`.
