...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=1711`, `Integration=516`, `Manual=73`, `Soak=1`, `External=0`, and `Hardware=1`.
