...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=2668`, `Integration=604`, `Manual=88`, `Soak=1`, `External=0`, and `Hardware=1`.
