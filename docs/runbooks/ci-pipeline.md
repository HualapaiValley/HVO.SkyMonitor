...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=1569`, `Integration=442`, `Manual=63`, `Soak=1`, `External=0`, and `Hardware=0`.
