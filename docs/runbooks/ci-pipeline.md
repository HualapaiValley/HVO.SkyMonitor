...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=1653`, `Integration=475`, `Manual=67`, `Soak=1`, `External=0`, and `Hardware=0`.
