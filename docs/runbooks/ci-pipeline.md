...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=2972`, `Integration=619`, `Manual=97`, `Soak=1`, `External=0`, and `Hardware=1`.
