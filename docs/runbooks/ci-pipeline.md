...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=3136`, `Integration=630`, `Manual=99`, `Soak=1`, `External=0`, and `Hardware=1`.
