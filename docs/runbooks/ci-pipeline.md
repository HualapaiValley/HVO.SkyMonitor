...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=3721`, `Integration=672`, `Manual=116`, `Soak=1`, `External=0`, and `Hardware=1`.
