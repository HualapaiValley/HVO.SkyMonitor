...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=2316`, `Integration=556`, `Manual=80`, `Soak=1`, `External=0`, and `Hardware=1`.
