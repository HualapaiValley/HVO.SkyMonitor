...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=3648`, `Integration=676`, `Manual=109`, `Soak=1`, `External=0`, and `Hardware=1`.
