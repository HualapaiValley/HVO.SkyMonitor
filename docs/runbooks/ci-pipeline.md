...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=2640`, `Integration=596`, `Manual=87`, `Soak=1`, `External=0`, and `Hardware=1`.
