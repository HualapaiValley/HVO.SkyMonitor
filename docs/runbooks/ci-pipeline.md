...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=1087`, `Integration=348`, `Manual=39`, `Soak=1`, `External=0`, and `Hardware=0`.
