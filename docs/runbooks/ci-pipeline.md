...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=3238`, `Integration=652`, `Manual=101`, `Soak=1`, `External=0`, and `Hardware=1`.
