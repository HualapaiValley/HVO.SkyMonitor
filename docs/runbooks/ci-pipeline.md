...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=2407`, `Integration=567`, `Manual=85`, `Soak=1`, `External=0`, and `Hardware=1`.
