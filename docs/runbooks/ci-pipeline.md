...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=2997`, `Integration=606`, `Manual=95`, `Soak=1`, `External=0`, and `Hardware=1`.
