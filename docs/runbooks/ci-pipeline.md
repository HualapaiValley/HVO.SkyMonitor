...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=3215`, `Integration=655`, `Manual=102`, `Soak=1`, `External=0`, and `Hardware=1`.
