...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=3176`, `Integration=647`, `Manual=101`, `Soak=1`, `External=0`, and `Hardware=1`.
