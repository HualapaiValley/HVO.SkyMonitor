...
The category audit requires every discovered case to belong to exactly one primary behavioral category. Current discovery is `Unit=3099`, `Integration=615`, `Manual=98`, `Soak=1`, `External=0`, and `Hardware=1`.
