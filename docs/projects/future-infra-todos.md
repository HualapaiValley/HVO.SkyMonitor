...
- Update `docker-compose.dev.yml` to mount the cert bundle into the host and agent containers, wiring the appropriate Kestrel and OpenIddict endpoints via environment variables.
