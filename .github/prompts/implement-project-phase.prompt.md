...
description: "Implement ready roadmap issues through one branch and PR at a time, continuing after merge."
...
existing `READY` signal and owning-epic claim assigned to its branch/worktree
before proceeding. Inspect the current worktree, branch, recent commits, tests, durable
