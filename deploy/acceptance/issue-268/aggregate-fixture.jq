...
def prom($cycles; $transactions; $checkpoints; $lockCount; $lockSeconds): {
  ...
  camera_agent_ingress_committed_bytes: ($cycles * 10),
...
def snapshot($captured; $started; $completed; $count; $prometheus): {
  ...
  hostBlockDevice: {name: "runtime", stat: ("8 0 " + ($captured / 1000 | tostring) + " 0 0 0 " +
...

{
  ...
  host: [{
    ...
    host: {nameRetained: false, logicalCpuCount: 8}, profile: {id: "asi178mc", model: "ASI178MC"},
    usb: {sysfsPathRetained: false},
    storage: {runtime: {logicalBlockSize: 512, path: "runtime", volumeInspectRetained: false, freeBytes: 1,
        containerMount: {type: "volume", sourceRetained: false, nameRetained: false, destination: "/var/lib/hvo/data/agent"}},
      evidence: {path: "evidence", freeBytes: 1}, docker: {path: "docker", freeBytes: 1}},
    mountAuthentication: {prestart: {passed: true},
      startup: {passed: true, sdkSha256: "fixture-sdk", sourcePathsRetained: false,
        runtime: {writable: true, mount: {Type: "volume", sourceRetained: false, nameRetained: false, Destination: "/var/lib/hvo/data/agent", RW: true}}},
      shutdown: {passed: true, sdkSha256: "fixture-sdk", sourcePathsRetained: false,
        runtime: {writable: true, mount: {Type: "volume", sourceRetained: false, nameRetained: false, Destination: "/var/lib/hvo/data/agent", RW: true}}}},
