...
internal sealed class Issue170PerformanceEvidence
{
    ...
    [
        ...
        "tests/HVO.SkyMonitor.LogicHost.IntegrationTests/DeviceBootstrapPerformanceTests.cs",
        "tests/HVO.SkyMonitor.LogicHost.IntegrationTests/DeploymentLocationAuthorityPerformanceTests.cs",
        ...
        "tests/HVO.SkyMonitor.LogicHost.IntegrationTests/Issue170PerformanceSummaryTests.cs",
        "tests/HVO.SkyMonitor.LogicHost.IntegrationTests/LogicHostIngestPerformanceTests.cs"
    ];
    ...
    private static string[] ReadContainerImages(string root)
        => System.Text.RegularExpressions.Regex.Matches(
                File.ReadAllText(Path.Combine(
                    root, "tests", "HVO.SkyMonitor.LogicHost.TestInfrastructure", "LogicHostIntegrationFixture.cs")),
                "\\.WithImage\\(\"(?<image>[^\"]+)\"\\)")
