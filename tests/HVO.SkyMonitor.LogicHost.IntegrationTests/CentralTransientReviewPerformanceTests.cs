    ...
    public async Task Issue118ReviewHistoryContentionAndReprocessing_RecordsAcceptanceEvidence()
    {
        ...
        try
        {
            ...
            var evidence = new
            {
                ...
                Command = "dotnet test tests/HVO.SkyMonitor.LogicHost.IntegrationTests/HVO.SkyMonitor.LogicHost.IntegrationTests.csproj --configuration Release --arch x64 --filter FullyQualifiedName~CentralTransientReviewPerformanceTests.Issue118ReviewHistoryContentionAndReprocessing_RecordsAcceptanceEvidence",
                Environment = new
                {
