...
public sealed partial class LogicHostIngestPerformanceTests
{
    ...
    private const string Issues437432Product = "63490cdfef496e2a702686c131f9689477800c95";
        ...
        ExpectedUpload rawUpload)
    {
        ...
        await using (var scope = fixture.Factory.Services.CreateAsyncScope())
        {
            ...
            var baseRow = new CentralArtifact
            {
                ...
                StorageReference = $"object://{ArtifactBucket}/issues-437-432/{baseArtifactId:D}.jpg",
    ...
    private static Issues437432Provenance ValidateIssues437432Provenance(string root, bool evidenceMode)
    {
        ...
        [
            ...
            "tests/HVO.SkyMonitor.LogicHost.IntegrationTests/LogicHostLayeredPerformanceTests.cs"
        ];
