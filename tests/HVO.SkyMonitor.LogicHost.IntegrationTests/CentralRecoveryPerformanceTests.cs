...
public sealed class CentralRecoveryPerformanceTests
{
    ...
    public async Task W3M_10000MetadataAndBoundedPayloadRecovery_RecordsExactEvidence()
    {
        ...
        var evidence = new
        {
            ...
            Command = "dotnet test tests/HVO.SkyMonitor.LogicHost.IntegrationTests/HVO.SkyMonitor.LogicHost.IntegrationTests.csproj --no-build --configuration Release --filter \"FullyQualifiedName~CentralRecoveryPerformanceTests.W3M_10000MetadataAndBoundedPayloadRecovery_RecordsExactEvidence\"",
            CanonicalW3PCommand = "HVO_RECOVERY_PERF_W3P=1 dotnet test tests/HVO.SkyMonitor.LogicHost.IntegrationTests/HVO.SkyMonitor.LogicHost.IntegrationTests.csproj --no-build --configuration Release --filter \"FullyQualifiedName~CentralRecoveryPerformanceTests.W3M_10000MetadataAndBoundedPayloadRecovery_RecordsExactEvidence\""
        };
