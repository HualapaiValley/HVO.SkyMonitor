...
public sealed class EnvironmentalObservationDeliveryPerformanceTests
{
    ...
    private const string RepeatCommand = "dotnet test tests/HVO.SkyMonitor.CameraAgent.LogicHost.IntegrationTests/HVO.SkyMonitor.CameraAgent.LogicHost.IntegrationTests.csproj --no-build --configuration Release --filter \"FullyQualifiedName~EnvironmentalObservationDeliveryPerformanceTests.Issue157_D1ToD5_RecordsReproducibleDeliveryEvidence\"";
