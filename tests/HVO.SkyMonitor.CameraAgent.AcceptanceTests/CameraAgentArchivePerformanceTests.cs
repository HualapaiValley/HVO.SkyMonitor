...
public sealed class CameraAgentArchivePerformanceTests
{
    ...
    public async Task ArchiveReadModelsRecordIssue514Evidence()
    {
        ...
        foreach (var captureCount in CaptureCounts)
        {
            ...
            foreach (var (name, sql, orderedWalkAllowed) in new[]
            {
