...
public sealed class NetworkAuthorityServiceTests
{
    ...
    public async Task OperationsReads_AreBoundedMembershipScopedAndOmitStorageReferences()
    {
        ...
        var artifact = new CentralArtifact
        {
            ...
            StorageReference = "object://skymonitor-artifacts/private-object-key",
            ReceivedAtUtc = Now,
            IdempotencyKey = Guid.NewGuid().ToString("N"),
            ObjectState = CentralArtifactObjectState.Available,
            ReconstructionState = CentralReconstructionState.Complete
        ...
        var preview = new CentralArtifact
        {
            ...
            StorageReference = "object://skymonitor-artifacts/private-preview-key",
            ReceivedAtUtc = Now,
            IdempotencyKey = Guid.NewGuid().ToString("N"),
            ObjectState = CentralArtifactObjectState.Available,
            ReconstructionState = CentralReconstructionState.Complete
        ...
        var activeImage = new CentralArtifact
        {
            ...
            ByteLength = 4,
            ChecksumSha256 = new string('D', 64),
            StorageReference = "object://skymonitor-artifacts/private-active-image-key",
            ReceivedAtUtc = Now,
            IdempotencyKey = Guid.NewGuid().ToString("N"),
            ObjectState = CentralArtifactObjectState.Available,
            ReconstructionState = CentralReconstructionState.Complete
        ...
        var json = JsonSerializer.Serialize(detail);
        json.Should().NotContain("private-object-key").And.NotContain("object://");
