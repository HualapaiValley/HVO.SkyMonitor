...
```bash
dotnet test tests/HVO.SkyMonitor.IntegrationTests/HVO.SkyMonitor.IntegrationTests.csproj --filter "FullyQualifiedName~HVO.SkyMonitor.IntegrationTests.HealthCheckTests.HealthCheckReturnsHealthyAsync"
```
