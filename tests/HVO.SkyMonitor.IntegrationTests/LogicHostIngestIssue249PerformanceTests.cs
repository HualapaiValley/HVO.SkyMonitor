...
public sealed partial class LogicHostIngestPerformanceTests
{
    ...
    [
        ...
        "tests/HVO.SkyMonitor.IntegrationTests/LogicHostIngestIssue249PerformanceTests.cs"
    ];
    ...
    public async Task DuplicateVerification_W1W2ConcurrencyAndDelay_RecordsBaselineEvidence()
    {
        ...
        var evidence = new
        {
            ...
            Command = "DOTNET_gcServer=1 HVO_EVIDENCE_PHASE=<baseline|after> HVO_EVIDENCE_REVISION=<HARNESS_OR_CANDIDATE_HEAD> HVO_EVIDENCE_PRODUCTION_REVISION=<PRODUCTION_HEAD> HVO_EVIDENCE_TRIAL=<1-5> dotnet test tests/HVO.SkyMonitor.IntegrationTests/HVO.SkyMonitor.IntegrationTests.csproj --no-build --configuration Release --filter FullyQualifiedName~LogicHostIngestPerformanceTests.DuplicateVerification_W1W2ConcurrencyAndDelay_RecordsBaselineEvidence",
            Workload = new
            {
