...
public sealed class CentralArtifactRetentionPerformanceTests
{
    ...
    public async Task Release_W2W4AndDelayedDelete_RecordsEvidence()
    {
        ...
        var evidence = new
        {
            ...
            Command = "HVO_ISSUE_246_RETENTION_EVIDENCE=1 HVO_EVIDENCE_REVISION=<HEAD> HVO_EVIDENCE_PRODUCTION_REVISION=<REVISION> HVO_EVIDENCE_PHASE=baseline|after HVO_EVIDENCE_TRIAL=1..5 dotnet test tests/HVO.SkyMonitor.IntegrationTests/HVO.SkyMonitor.IntegrationTests.csproj --no-build --configuration Release --filter FullyQualifiedName~CentralArtifactRetentionPerformanceTests.Release_W2W4AndDelayedDelete_RecordsEvidence",
