    ...
    public async Task Issue103_E1ToE5_RecordsCanonicalEvidence()
    {
        ...
        try
        {
            ...
            var evidence = new
            {
                ...
                Command = "dotnet test tests/HVO.SkyMonitor.IntegrationTests/HVO.SkyMonitor.IntegrationTests.csproj --no-build --configuration Release --filter \"FullyQualifiedName~EnvironmentalObservationPerformanceTests\"",
                Environment = new
                {
