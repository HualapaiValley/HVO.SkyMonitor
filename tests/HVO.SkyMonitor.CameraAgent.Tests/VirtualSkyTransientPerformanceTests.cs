...
public sealed class VirtualSkyTransientPerformanceTests
{
    ...
    private static readonly Dictionary<(string Workload, string Scenario), OutputChecksums> ExpectedChecksums = new()
    {
        ...
        [("W2", "explicit-empty")] = new(
            "9B6FF2F25CDBC732F6C0FB38263E60C5D419F779C3D79462BD941B986CB3EE19",
            "ADFD83961E5222FE8F8E9B168D3FD1BCA51FD7E43955D71F29B75CAEC30C4F0D"),
        [("W2", "short-sky-track")] = new(
            "A124FDE2EA2758E6F93BC1848AA0156CBAECC8090BB1D07162A6C5EFB6D80CB4",
            "BBEAC39D27CCA251FAFE56CF5DE4D0C4EBA9F41933E7C8BB950620725C76D66C"),
        [("W2", "saturated-fragmented-track")] = new(
            "BC200FCD5641AC32F42CF93166E87E3AC8A506DFB6A632FB8C4F4516DEFE4A4B",
            "4BC764605CAC2421484CBEBC51261FDE1D105C3340450AB9F1F42A37FE54C539"),
        [("W2", "long-shadow-blink")] = new(
            "FCEDAC6F1FDC83B1ADCDFCA6C141CC131F0B9BB74F2D3734B6C4D53E4CA4466D",
            "87A7B1AD9B3A4D7656DCA377F19441E6FF92525EFA341C4B87D28D5D8E111E89"),
        [("W2", "sensor-artifacts")] = new(
            "A47BCBA2BB265596B241A70F2E6FA9C170D648F630FA82BFFA7CD1D89EB486BE",
            "7B09D16A04BC2722A964D2F8904DB71844277558C8DEBA2F1BB7B13EB8068281"),
        [("W2", "partial-cloud-sky-track")] = new(
            "641B0B495110489447708C46238B3B7B5BFC8C3E51D063BD19A447D671EA6A20",
            "00EAF9C74F5940538F9455F7FAD283ED0B241567BB80353726DD664E24C927E1")
    };
