    ...
    Action? inspectionSourceOpenedSeam = null)
{
    ...
    private static readonly HashSet<string> SharedSchemaObjectNames = new(StringComparer.Ordinal)
    {
        ...
        "processing_graph_delivery_proposals",
        "processing_graph_delivery_facts",
        ...
        "ix_processing_graph_delivery_proposals_lookup",
        "ix_processing_graph_delivery_facts_pending",
        "ix_processing_graph_delivery_facts_lifecycle",
        "ix_processing_graph_delivery_facts_settlement",
