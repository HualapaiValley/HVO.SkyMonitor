...
public sealed class CameraAgentExceptionHandler : IExceptionHandler
{
    private readonly ILogger<CameraAgentExceptionHandler> _logger;
    private readonly ProblemDetailsFactory _problemDetailsFactory;
    private readonly IOptions<ProblemDetailsOptions> _problemDetailsOptions;

    public CameraAgentExceptionHandler(
        ILogger<CameraAgentExceptionHandler> logger,
