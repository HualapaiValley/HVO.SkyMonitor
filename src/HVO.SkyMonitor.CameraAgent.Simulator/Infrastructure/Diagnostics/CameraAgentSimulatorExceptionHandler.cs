...
public sealed class CameraAgentSimulatorExceptionHandler : IExceptionHandler
{
    private readonly ILogger<CameraAgentSimulatorExceptionHandler> _logger;
    private readonly ProblemDetailsFactory _problemDetailsFactory;
    private readonly IOptions<ProblemDetailsOptions> _problemDetailsOptions;

    public CameraAgentSimulatorExceptionHandler(
        ILogger<CameraAgentSimulatorExceptionHandler> logger,
