...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HVO.SkyMonitor.CameraAgent.Simulator.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HVO.SkyMonitor.CameraAgent.Simulator.Data.ApplicationUserApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("HVO.SkyMonitor.CameraAgent.Simulator.Data.ApplicationUserApiKey", b =>
                {
                    b.HasOne("HVO.SkyMonitor.CameraAgent.Simulator.Data.ApplicationUser", "User")
                        .WithMany("ApiKeys")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HVO.SkyMonitor.CameraAgent.Simulator.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
